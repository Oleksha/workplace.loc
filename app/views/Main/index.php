          ...
          <table id="main_index" class="display" style="width:100%">
              ...
              <?php foreach ($receipt as $item): ?>
                  ...
                  <tr>
                      ...
                      <td><?= $status;?></td>
                      <td>
                          <button type="button" class="btn btn-outline-success payment_pay_link" data-toggle="tooltip" data-placement="top" title="Оплатить" data-id_receipt="<?= $item['id_receipt'];?>">
